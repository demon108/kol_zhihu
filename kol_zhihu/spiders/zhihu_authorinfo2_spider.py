...
class ZhihuAuthorSpider(Spider):
    ...
    name = 'zhihu_authorinfo2'
    
    total = 0
    rediskey = 'zhihu_author2'
    def __init__(self):
        self.init_redis()
    ...
    def parse_author_info(self,response):
        ...
        open('author_info2_ids.dat','w').write(author_id+'\n')
        try:
        ...
        likenum2 = sel.xpath('//span[@class="zm-profile-header-user-agree"]/child::strong/text()').extract()[0]
        thanksnum = sel.xpath('//span[@class="zm-profile-header-user-thanks"]/child::strong/text()').extract()[0]
